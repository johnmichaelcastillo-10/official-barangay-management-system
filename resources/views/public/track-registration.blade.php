            ...
            <div class="col-lg-6 col-md-8">
                <div class="track-card">
                    <div class="card-header">
                        ...
                        <h1 class="header-title">Track Your Registration</h1>
                        <p class="header-subtitle">Enter your reference number to check your registration status</p>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <!-- Tracking Form -->
                        <form action="{{ route('residents.track.result') }}" method="POST">
                            @csrf
                            ...
                            <div class="example-format">
                                ...
                                <strong>REG-2025-000026</strong>
                            </div>

                            <!-- Submit Button -->
                            <div class="mb-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-search me-2"></i>Track Registration
                                </button>
                            </div>
                        ...
                        <div class="info-box">
                            ...
                            <div class="info-text">
                                Enter the reference number you received after completing your registration.
                                This number was provided on your registration confirmation page and should be saved for your records.
                            </div>
                        </div>
