...
<head>
    ...
    <style>
        ...
        .status-badge-approved, .payment-status-paid {
...
<body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="detail-item">
                            ...
                            <div class="detail-value-form">{{ $documentRequest->actual_release_date ? \Carbon\Carbon::parse($documentRequest->actual_release_date)->format('M d, Y') : 'Not Released Yet' }}</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    @else
        <div class="container text-center no-request-found">
            ...
            <a href="{{ route('document-request.track.show') }}" class="btn btn-primary-no-request mt-3">
