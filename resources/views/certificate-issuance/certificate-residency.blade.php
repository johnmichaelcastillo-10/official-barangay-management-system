...
<body>
    ...
    <div class="content">
        <p>This is to certify that <strong>{{ $request->resident->full_name }}</strong>, of legal age, a citizen of the Philippines, is a bona fide resident of Barangay {{ $barangayName ?? 'Sample Barangay' }}, {{ $cityName ?? 'Sample City' }}.</p>

        <p>This certification is being issued upon the request of the abovenamed individual for the purpose of <strong>{{ $request->purpose }}</strong>.</p>
    </div>
